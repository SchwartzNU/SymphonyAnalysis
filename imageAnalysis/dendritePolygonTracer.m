function [DSI,OSI,DSang,OSang,Area,COM,Ecc,Maj,Min,Poly] = dendritePolygonTracer(fname)
    ...
    center = midPoint(Poly(ind_center1,:),Poly(ind_center2,:));
