...
outputSaveFilename = 'analysisTrees/automaticData/autodata_color';
...
%    'analysisTrees/automaticData/filter colorIso CA.mat' {'modelCoefs','modelCoefs_pValues'} {'colorIsoModel_coefs','colorIsoModel_pValues'}
%%
analyses = table();
dtabColumns = table();
