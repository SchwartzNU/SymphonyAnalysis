function T = typologyTree_remodel_1
...
singleTypeNodeList =  {
    ...
    [222212222, 22222222];
    [22222221];
    [12221, 222221]; %prev. [122222, 222221];
    [222121]
    [22211,2222121];
    [122222] %prev. [12221];
...
%Separate parameter names by SPACES; analysisTree other than LS put stim.
%initials in beginning.
cl = {'ONOFFindex.mean_c < -0.5';
    'ONOFFindex.mean_c > -0.5';
    'baselineRate.mean_c > 60';
    'baselineRate.mean_c < 60';
    'MB spikeCount_stimInterval_DSI > 0.18';
    'MB spikeCount_stimInterval_DSI < 0.18';
    ...
    'baselineRate.mean_c > 2';
    'spikeCount_stimInterval.mean_c > 3.5'; %more params possible, see paramLists saved.
    'spikeCount_stimInterval.mean_c < 3.5';
    'FB ??';
    'FB ??';
    'ONSETrespDuration.mean_c > 0.4';
    'ONSETrespDuration.mean_c < 0.4';
    'MB8000 OFFSETspikes_grandBaselineSubtracted_generalMean > 5';
    'MB8000 OFFSETspikes_grandBaselineSubtracted_generalMean < 5';
    '( OFFSETburstNonBurstRatio_duration.mean_c > 0.5 ) && ( blistQ10.value < 0.02 )';
    '~(( OFFSETburstNonBurstRatio_duration.mean_c > 0.5 ) && ( blistQ10.value < 0.02 ))';
    'OFFSETburstNonBurstRatio_duration.mean_c && spikeCount_OFFSET_400ms_baselineSubtracted.mean_c'; %FB??? JAM-B!!
    %prev 'ONSET_FRmax.value > 85';
    'OFFSETburstNonBurstRatio_duration.mean_c && spikeCount_OFFSET_400ms_baselineSubtracted.mean_c'; %FB??? JAM-B!!
    %prev 'ONSET_FRmax.value < 85';
