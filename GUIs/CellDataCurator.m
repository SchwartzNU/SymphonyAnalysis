    ...
    methods
        ...
        function buildUIComponents(obj)
            ...
            obj.handles.diaryXMenu = uicontrol('Parent', L_diaryMenu, ...
                ...
                'Units', 'normalized', ...
                'Callback', @(uiobj, evt)obj.updateDiaryPlot);            
            set(L_diaryMenu, 'Sizes', [40, 200, 40, 200], 'Spacing', 10);
            ...
            set(L_scrollButtons, ...
                'ButtonSize', [30 20]);
            L_controls = uiextras.HBox('Parent', L_dataPanels, 'Spacing', 5);
            ...
            set(L_controls, 'Sizes', [75, 150, 80, 80, 80]);
