...
%             obj.epochIndicesList = epochIndicesList; % don't even use it if we're just overwriting it
        ...
        function buildUI(obj)
            ...
            obj.handles.applyToFutureButton = uicontrol('Parent', sideButtonBlock, ...
                'Style', 'pushbutton', ...
                'String', 'Apply to this & future', ...
                'Callback', @(uiobj, evt)obj.updateFutureSpikeTimes());
            obj.handles.skipBackward10 = uicontrol('Parent', sideButtonBlock, ...
                'Style', 'pushbutton', ...
                'String', 'Back 10', ...
                'Callback', @(uiobj, evt)obj.skipBackward10());
            obj.handles.skipForward10 = uicontrol('Parent', sideButtonBlock, ...
                'Style', 'pushbutton', ...
                'String', 'Forward 10', ...
                'Callback', @(uiobj, evt)obj.skipForward10());
            
            set(L_main, 'Sizes', [50, -1]);
            set(L_info, 'Sizes', [-.7, -1, -1, -1.5, -1, -.6, -1, -1, -1, -1]);
            set(L_plotAndButtons, 'Sizes', [-1, 120]);
        end
