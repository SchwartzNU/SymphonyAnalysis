        ...
        function obj = doAnalysis(obj, cellData)
            ...
            for i=1:L
                ...
                if strcmp(obj.respType, 'Spike count')
                    ...
                    [spikes, respUnits, intervalLen(i)] = getEpochResponses(cellData, curNode.epochID, 'Spike count', 'DeviceName', rootData.deviceName, ...
                        'BaselineTime', 250, 'StartTime', obj.StartTime, 'EndTime', obj.EndTime, 'EndOffset', 0);
                    N = length(spikes);
                elseif strcmp(obj.respType, 'Peak firing rate')
                    [baselineRate, respUnits] = getEpochResponses(cellData, curNode.epochID, 'Baseline firing rate', 'DeviceName', rootData.deviceName, ...
                        'BaselineTime', 250, 'StartTime', obj.StartTime, 'EndTime', obj.EndTime, 'EndOffset', 0, 'BinWidth', obj.PSTH_bin_width);
                    [peakRate, respUnits] = getEpochResponses(cellData, curNode.epochID, 'Peak firing rate', 'DeviceName', rootData.deviceName, ...
                        'BaselineTime', 250, 'StartTime', obj.StartTime, 'EndTime', obj.EndTime, 'EndOffset', 0, 'BinWidth', obj.PSTH_bin_width);
                    N = length(peakRate);
